define(['app/services/hotel-service',
    ...
    modules.controllers
        .controller('HotelDestController', ['_', '$rootScope', '$scope', '$location', 'SessionService',
            ...
            function (_, $rootScope, $scope, $location, SessionService, HotelService, LanguageService, $translate, $cookieStore, $filter, SearchService,
                ...
                $scope.selectedLocation = criteria?criteria.locationId:$routeParams.destinationId;
                $scope.selectedLocationName = criteria?criteria.locationName:$routeParams.name;
